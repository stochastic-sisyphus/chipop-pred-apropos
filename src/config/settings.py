...
# Downtown and Priority ZIP Codes for specific analysis
DOWNTOWN_ZIPS = [
...
SOUTH_SIDE_ZIPS = [
    ...
    "60633", "60636", "60637", "60643", "60649", "60653", "60655", "60827"
]
WEST_SIDE_ZIPS = [
    "60608", "60612", "60622", "60623", "60624", "60642", "60644", "60651"
]
PRIORITY_ZIPS = SOUTH_SIDE_ZIPS + WEST_SIDE_ZIPS
...
# Model parameters
POPULATION_MODEL_PARAMS = {"n_estimators": 100, "max_depth": 10, "random_state": 42}

RETAIL_MODEL_PARAMS = {"n_estimators": 100, "max_depth": 8, "random_state": 42}

HOUSING_MODEL_PARAMS = {"n_estimators": 100, "max_depth": 8, "random_state": 42}

ECONOMIC_MODEL_PARAMS = {"n_estimators": 100, "max_depth": 8, "random_state": 42}

# Scenario parameters
SCENARIOS = {
    "base": {"growth_factor": 1.0, "confidence": 1.0},
    "optimistic": {"growth_factor": 1.2, "confidence": 0.9},
    "neutral": {"growth_factor": 1.0, "confidence": 0.8},
    "pessimistic": {"growth_factor": 0.8, "confidence": 0.7},
}

# Visualization settings
VIZ_SETTINGS = {"width": 1200, "height": 800, "template": "plotly_white"}

# Report settings
REPORT_SETTINGS = {"date_format": "%Y-%m-%d", "confidence_level": 0.95}
...
__all__ = [
    ...
    "CENSUS_DATA_PATH",
    "PERMITS_DATA_PATH",
    "BUSINESS_LICENSES_PATH",
    "ECONOMIC_DATA_PATH",
    "CENSUS_PROCESSED_PATH",
    "PERMITS_PROCESSED_PATH",
    "ECONOMIC_PROCESSED_PATH",
    "BUSINESS_LICENSES_PROCESSED_PATH",
    "MERGED_DATA_PATH",
    "RETAIL_SALES_PATH",
    "DEMOGRAPHIC_DATA_PATH",
    "RETAIL_DEFICIT_PROCESSED_PATH",
    "RETAIL_LEAKAGE_SUMMARY_PATH",
    
    # Model paths
    "POPULATION_MODEL_PATH",
    "ECONOMIC_MODEL_PATH",
    "HOUSING_MODEL_PATH",
    "RETAIL_MODEL_PATH",
    "RETAIL_DEFICIT_PATH",
    ...
    "RETAIL_DEFICIT_REPORT_PATH",
    "HOUSING_RETAIL_BALANCE_REPORT_PATH",
    "TEN_YEAR_GROWTH_REPORT_PATH",
    "PERMITS_DISTRIBUTION_PATH",
    "RETAIL_DEFICIT_MAP_PATH",
    "ECONOMIC_INDICATORS_PATH",
    ...
    "FRED_SERIES",
    "ZONING_DATASET",
    "PROPERTY_TRANSACTIONS_DATASET",
    "BUSINESS_LICENSES_DATASET",
    "DEFAULT_TRAIN_YEARS",
    "FORECAST_YEARS",
    "RETAIL_SPENDING_FACTOR",
